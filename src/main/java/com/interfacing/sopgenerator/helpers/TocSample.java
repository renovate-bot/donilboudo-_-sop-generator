...
public class TocSample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        wordMLPackage.save(new java.io.File("OUT_TocSample_Generated.docx"));
        ...
        if (update)
        {
            ...
            wordMLPackage.save(new java.io.File("OUT_TocSample_Updated.docx"));
        }

        if (createPDF)
        {
            OutputStream os = new java.io.FileOutputStream("OUT_TocSample_Updated.pdf");
